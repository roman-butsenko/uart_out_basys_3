...
synth_design -top uart_out -part xc7a35tcpg236-3
...
write_checkpoint -force -noxdef uart_out.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file uart_out_utilization_synth.rpt -pb uart_out_utilization_synth.pb"
