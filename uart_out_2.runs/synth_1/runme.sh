...
HD_PWD='C:/Xilinx/projects/uart_out_basys_3/uart_out_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_out.tcl
